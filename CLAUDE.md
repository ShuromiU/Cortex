...
- The whole note write is one transaction. Detect → supersede → insert → mark is four statements, and a concurrent writer landing between them supersedes the row the write just decided to protect.
